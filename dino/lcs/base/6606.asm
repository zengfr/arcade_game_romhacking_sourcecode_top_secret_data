...
0048B6	movea.w (A4)+, A0		[base+6606]
0048B8	move.w  A4, ($6606,A5)		[base+66F8, base+66FA, base+66FC, base+66FE, base+6700, base+6702, base+6704, base+6706, base+6708, base+670A, base+670C, base+670E]
0048BC	subq.w  #1, ($65fc,A5)		[base+6606]
004994	movea.w ($6606,A5), A4		
004998	move.w  D0, -(A4)		[base+6606]
00499A	move.w  A4, ($6606,A5)		[base+66FA, base+66FC, base+66FE, base+6700, base+6702, base+6704, base+6706, base+6708, base+670A, base+670C, base+670E]
00499E	addq.w  #1, ($65fc,A5)		[base+6606]
004CE2	move.w  A1, ($6606,A5)		
004CE6	move.w  #$10, ($65fc,A5)		[base+6606]
0AAACA	move.l  (A0), D2		
