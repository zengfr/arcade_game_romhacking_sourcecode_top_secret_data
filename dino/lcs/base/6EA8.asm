...
00042A	move.l  D1, (A0)+		
00042C	dbra    D0, $42a		
016B08	move.l  A6, (A4)		[base+6EA4, item+26]
016B0A	addi.b  #$10, D1		[base+6EA8]
016BDA	move.l  A6, (A4)		[123p+ 6C, base+6DE4, base+6DF4, base+6E04, base+6E14, base+6E24, base+6E44, base+6E54, base+6E74, base+6E94, base+6EA4, base+6EC4, base+6ED4, enemy+6C]
016BDC	addi.b  #$10, D1		[base+6DE8, base+6DF8, base+6E08, base+6E18, base+6E28, base+6E38, base+6E48, base+6E58, base+6E68, base+6E78, base+6E88, base+6E98, base+6EA8, base+6EB8, base+6EC8, base+6ED8]
0AAACA	move.l  (A0), D2		
