...
016B74	addi.b  #$10, D1		[base+6BE8, base+6BF8, base+6C08, base+6C18, base+6C28, base+6C38, base+6C48, base+6C58, base+6C68, base+6C78, base+6C88, base+6C98, base+6CA8, base+6CB8, base+6CC8, base+6CD8]
0AAACA	move.l  (A0), D2		
