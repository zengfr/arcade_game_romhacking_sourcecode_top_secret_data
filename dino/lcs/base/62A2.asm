...
00042C	dbra    D0, $42a		
0148EE	move.w  (A1)+, D0		
0148F0	add.w   D4, D0		[base+6002, base+6022, base+602A, base+6102, base+610A, base+6112, base+611A, base+6182, base+618A, base+6192, base+619A, base+61A2, base+61AA, base+6222, base+622A, base+630A, base+6312, base+631A, base+6382, base+6392, base+639A, base+63A2, base+63AA, base+63B2, base+6422, base+642A, base+650A, base+6512, base+6582, base+658A, base+6592, base+659A, base+65A2]
07E7E8	move.l  D0, (A0)+		
07E7EA	dbra    D1, $7e7e8		
07E9CE	move.w  D1, (A1)+		
07E9D0	move.w  D2, (A1)+		[base+62A2, base+62AA, base+62B2, base+6322, base+632A, base+6332, base+63A2, base+63AA, base+63B2, base+64A2, base+64AA, base+64B2, base+6522, base+652A, base+6532]
07EA8E	move.w  D1, (A1)+		
