...
004B4C	moveq   #$1a, D0		[base+6AC4]
004B58	movea.w ($6ac4,A5), A4		
004B5C	move.w  A6, -(A4)		[base+6AC4]
004B5E	move.w  A4, ($6ac4,A5)		[base+6AF0, base+6AF2, base+6AF4, base+6AF6, base+6AF8, base+6AFA]
004B62	addq.w  #1, ($6ac2,A5)		[base+6AC4]
010646	move.w  A0, ($6ac4,A5)		
01064A	move.w  D0, ($6afc,A5)		[base+6AC4]
011F8E	movea.w ($6ac4,A5), A0		
011F92	subq.w  #1, D7		[base+6AC4]
0AAACA	move.l  (A0), D2		
