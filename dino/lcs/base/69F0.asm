...
004AB6	moveq   #$17, D0		[base+69F0]
004ACC	movea.w ($69f0,A5), A4		
004AD0	move.w  A6, -(A4)		[base+69F0]
004AD2	move.w  A4, ($69f0,A5)		[base+6A14, base+6A16, base+6A18, base+6A1A, base+6A1C, base+6A1E, base+6A20]
004AD6	addq.w  #1, ($69ee,A5)		[base+69F0]
005AC6	movea.w ($69f0,A5), A0		
005ACA	movea.w (A0)+, A1		[base+69F0]
00E930	move.w  A0, ($69f0,A5)		
00E934	clr.b   ($4fa,A5)		[base+69F0]
0AAACA	move.l  (A0), D2		
