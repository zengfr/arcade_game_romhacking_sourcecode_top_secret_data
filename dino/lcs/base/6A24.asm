...
004A82	clr.w   ($6a26,A5)		[base+6A24]
004A9A	movea.w ($6a24,A5), A4		[item+AC]
004A9E	move.w  A6, -(A4)		[base+6A24]
004AA0	move.w  A4, ($6a24,A5)		[base+6A4C, base+6A4E, base+6A50, base+6A52, base+6A54, base+6A56, base+6A58]
004AA4	addq.w  #1, ($6a22,A5)		[base+6A24]
00E9C4	move.w  A0, ($6a24,A5)		
00E9C8	jsr     $670c.l		[base+6A24]
0AAACA	move.l  (A0), D2		
