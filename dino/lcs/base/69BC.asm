...
004A3A	moveq   #$17, D0		[base+69BC]
006266	movea.w ($69bc,A5), A0		
00626A	movea.w (A0)+, A1		[base+69BC]
006500	movea.w ($69bc,A5), A0		
006504	move.w  #$100, D5		[base+69BC]
010608	move.w  ($6726,A5), ($69bc,A5)		[base+69BA]
01060E	move.w  D0, ($671e,A5)		[base+69BC]
04F26A	movea.w ($69bc,A5), A0		
04F26E	moveq   #-$1, D6		[base+69BC]
04F2EE	movea.w ($69bc,A5), A1		
04F2F2	movea.w (A1)+, A0		[base+69BC]
05F3DC	movea.w ($69bc,A5), A0		
05F3E0	movea.w (A0)+, A1		[base+69BC]
0AAACA	move.l  (A0), D2		
