...
00042A	move.l  D1, (A0)+		
00042C	dbra    D0, $42a		
016AFC	move.w  ($6a,A6), (A4)+		[base+6E9F, item+ 3]
016B00	move.w  ($6e,A6), (A4)+		[base+6EA0, item+6A]
016BCE	move.w  ($6a,A6), (A4)+		[123p+  3, base+6DDF, base+6DEF, base+6DFF, base+6E0F, base+6E2F, base+6E4F, base+6E6F, base+6E7F, base+6E8F, base+6E9F, base+6EAF, base+6EBF, base+6ECF, enemy+ 3]
016BD2	move.w  ($6e,A6), (A4)+		[123p+ 6A, base+6DE0, base+6DF0, base+6E00, base+6E10, base+6E30, base+6E50, base+6E70, base+6E90, base+6EA0, base+6EB0, base+6EC0, base+6ED0, enemy+6A]
