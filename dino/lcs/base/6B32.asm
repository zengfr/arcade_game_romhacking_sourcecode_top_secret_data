...
004BA4	moveq   #$17, D0		[base+6B32]
004BB0	movea.w ($6b32,A5), A4		
004BB4	move.w  A6, -(A4)		[base+6B32]
004BB6	move.w  A4, ($6b32,A5)		[base+6B62]
004BBA	addq.w  #1, ($6b30,A5)		[base+6B32]
01065E	move.w  A0, ($6b32,A5)		
010662	rts		[base+6B32]
011862	movea.w ($6b32,A5), A0		
011866	subq.w  #1, D7		[base+6B32]
0AAACA	move.l  (A0), D2		
