...
004CD8	move.w  A0, -(A1)		
004CDA	lea     ($80,A0), A0		[base+66F8, base+66FA, base+66FC, base+66FE, base+6700, base+6702, base+6704, base+6706, base+6708, base+670A, base+670C, base+670E, base+6710, base+6712, base+6714, base+6716]
0AAACA	move.l  (A0), D2		
