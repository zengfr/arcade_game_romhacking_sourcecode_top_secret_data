...
0168F4	move.b  #$0, ($5,A6)		[base+6BC8]
016CF2	move.b  ($0,A6), D0		
016CF6	bsr     $16c98		[base+6BA8, base+6BB8, base+6BC8]
016F20	move.b  ($0,A6), D0		
016F24	bsr     $16cca		[base+6BA8, base+6BB8, base+6BC8]
017198	move.b  ($0,A6), D0		
01719C	subq.b  #1, D0		[base+6BA8, base+6BB8, base+6BC8]
017836	move.b  ($0,A6), D4		
01783A	add.w   D4, D4		[base+6BA8, base+6BB8, base+6BC8]
0238AA	move.b  ($0,A6), D0		
0238AE	subq.w  #1, D0		[base+6BA8, base+6BB8, base+6BC8]
023F3E	move.b  ($0,A6), D0		
023F42	subq.w  #1, D0		[base+6BA8, base+6BB8, base+6BC8]
024328	move.b  ($0,A6), D0		
02432C	subq.w  #1, D0		[base+6BA8, base+6BB8, base+6BC8]
0AAACA	move.l  (A0), D2		
