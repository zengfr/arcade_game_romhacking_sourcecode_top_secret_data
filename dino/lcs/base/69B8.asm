...
013FE6	subq.w  #1, (-$7126,A5)		[base+69B8]
0141D6	sub.w   ($69b8,A5), D5		[base+69B6]
0141DA	not.b   D5		[base+69B8]
014272	sub.w   ($69b8,A5), D5		[base+69B6]
014276	not.b   D5		[base+69B8]
014824	sub.w   ($69b8,A5), D5		[base+69B6]
014828	not.b   D5		[base+69B8]
014F14	sub.w   ($69b8,A5), D1		[123p+ 10, enemy+10, item+10]
014F18	not.b   D1		[base+69B8]
0AAACA	move.l  (A0), D2		
