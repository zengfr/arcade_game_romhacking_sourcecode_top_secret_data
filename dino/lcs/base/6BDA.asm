...
0169B8	move.b  ($6bda,A5), D1		
0169BC	adda.w  D1, A4		[base+6BDA]
016A00	move.b  D1, ($6bda,A5)		
016A04	rts		[base+6BDA]
016AB6	move.b  ($6bda,A5), D1		
016ABA	adda.w  D1, A4		[base+6BDA]
016ADE	move.b  D1, ($6bda,A5)		
016AE2	rts		[base+6BDA]
016B88	move.b  ($6bda,A5), D1		
016B8C	adda.w  D1, A4		[base+6BDA]
016BB0	move.b  D1, ($6bda,A5)		
016BB4	rts		[base+6BDA]
0AAACA	move.l  (A0), D2		
