...
004AE8	moveq   #$17, D0		[base+6A5C]
004AFE	movea.w ($6a5c,A5), A4		
004B02	move.w  A6, -(A4)		[base+6A5C]
004B04	move.w  A4, ($6a5c,A5)		[base+6A88, base+6A8A, base+6A8C]
004B08	addq.w  #1, ($6a5a,A5)		[base+6A5C]
006618	movea.w ($6a5c,A5), A0		
00661C	move.w  #$ffff, ($88,A6)		[base+6A5C]
00E950	move.w  A0, ($6a5c,A5)		
00E954	clr.w   ($6a8e,A5)		[base+6A5C]
0AAACA	move.l  (A0), D2		
