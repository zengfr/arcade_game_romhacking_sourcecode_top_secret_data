...
00042A	move.l  D1, (A0)+		
00042C	dbra    D0, $42a		
0169CA	move.w  ($6a,A6), (A4)+		[base+6CFF, base+6D9F, base+6DAF, base+6DBF]
0169CE	move.w  ($6e,A6), (A4)+		[base+6D00, base+6DA0, base+6DB0, base+6DC0]
016B9A	move.w  ($6a,A6), (A4)+		[123p+  3, base+6CDF, base+6CEF, base+6CFF, base+6D0F, base+6D1F, base+6D2F, base+6D3F, base+6D4F, base+6D5F, base+6D6F, base+6D7F, base+6D8F, base+6D9F, base+6DAF, base+6DBF, base+6DCF, enemy+ 3]
016B9E	move.w  ($6e,A6), (A4)+		[123p+ 6A, base+6CE0, base+6CF0, base+6D00, base+6D10, base+6D20, base+6D30, base+6D40, base+6D50, base+6D60, base+6D70, base+6D90, base+6DA0, base+6DB0, base+6DC0, base+6DD0, enemy+6A]
