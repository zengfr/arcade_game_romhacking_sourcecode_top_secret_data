...
00042A	move.l  D1, (A0)+		
00042C	dbra    D0, $42a		
01697A	move.w  ($6e,A6), (A4)+		[base+6BE0, base+6C10, base+6C20, base+6C30, base+6C40, item+6A]
01697E	move.w  ($6c,A6), (A4)+		[base+6BE2, base+6C12, base+6C22, base+6C32, base+6C42, item+6E]
