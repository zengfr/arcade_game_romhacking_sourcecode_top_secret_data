...
004C10	move.w  A4, ($6b66,A5)		[base+6B92, base+6B94, base+6B96]
011354	movea.w (A1)+, A3		[base+6B66]
011356	btst    #$1, ($0,A3)		[base+6B92, base+6B94, base+6B96]
011AE6	movea.w (A1)+, A3		[base+6B66]
011AE8	btst    #$1, ($0,A3)		[base+6B92, base+6B94, base+6B96]
011CFC	movea.w (A0)+, A2		
011CFE	cmpi.b  #$4, ($2e,A2)		[base+6B92, base+6B94, base+6B96]
011E66	movea.w (A0)+, A2		
011E68	cmpi.b  #$4, ($2e,A2)		[base+6B92, base+6B94, base+6B96]
0AAACA	move.l  (A0), D2		
