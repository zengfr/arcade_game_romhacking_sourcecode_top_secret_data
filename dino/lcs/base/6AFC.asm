...
004B96	rts		[base+6AFC]
01064A	move.w  D0, ($6afc,A5)		[base+6AC4]
01064E	lea     ($6b30,A5), A0		
011F98	move.w  ($6afc,A5), D7		[base+6AF0, base+6AF2, base+6AF4, base+6AF6, base+6AF8, base+6AFA]
011F9C	beq     $11fac		[base+6AFC]
012036	move.w  ($6afc,A5), D7		
01203A	beq     $1205e		[base+6AFC]
0120EE	move.w  ($6afc,A5), D7		
0120F2	beq     $12132		[base+6AFC]
0AAACA	move.l  (A0), D2		
