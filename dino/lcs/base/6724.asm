...
004A52	moveq   #$17, D0		[base+6724]
004BFA	movea.w ($6724,A5), A4		
004BFE	move.w  A6, -(A4)		[base+6724]
004C00	move.w  A4, ($6724,A5)		[base+678C]
004C04	addq.w  #1, ($671c,A5)		[base+6724]
01062E	move.w  A0, ($6724,A5)		
010632	move.w  D0, ($6b64,A5)		[base+6724]
010CEC	movea.w ($6724,A5), A1		
010CF0	movea.w (A1)+, A3		[base+6724]
0AAACA	move.l  (A0), D2		
