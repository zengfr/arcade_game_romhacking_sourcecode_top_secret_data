...
004840	beq     $485a		[base+65F8]
004850	subq.w  #1, ($65f8,A5)		[base+6602]
004854	movea.l (A7)+, A4		[base+65F8]
004906	addq.w  #1, ($65f8,A5)		[base+6602]
00490A	moveq   #$0, D0		[base+65F8]
004C6E	move.w  #$18, ($65f8,A5)		[base+6602]
004C74	rts		[base+65F8]
0358CE	cmpi.w  #$2, ($65f8,A5)		
0358D4	blt     $36a0a		[base+65F8]
04022C	cmpi.w  #$2, ($65f8,A5)		
040232	blt     $41e90		[base+65F8]
0AAACA	move.l  (A0), D2		
