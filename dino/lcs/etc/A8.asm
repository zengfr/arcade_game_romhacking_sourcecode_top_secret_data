...
07BF28	clr.b   ($ae,A6)		
07BFA4	subq.w  #1, ($a8,A6)		
07BFA8	rts		[etc+A8]
07BFB2	move.w  D0, ($a8,A6)		
07BFB6	moveq   #$0, D0		[etc+A8]
07BFE6	move.w  D0, ($a8,A6)		
