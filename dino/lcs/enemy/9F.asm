...
0404A6	rts		[enemy+1E, enemy+3E, enemy+5E, enemy+7E, enemy+9E, enemy+BE]
0404AE	rts		
0404B4	beq     $404c8		
0404C0	bra     $404c8		[enemy+1F, enemy+7F, enemy+9F]
0404C8	rts		[enemy+1F, enemy+3F, enemy+7F, enemy+9F]
0404CE	bne     $40574		
0404FE	move.b  ($24,A0), D0		[enemy+56]
...
040D5A	bne     $40d6e		[enemy+ 6, enemy+26, enemy+66, enemy+86]
040D6A	bra     $41be8		[enemy+1F, enemy+7F, enemy+9F]
copyright	zengfr	site:http://github.com/zengfr/romhack
