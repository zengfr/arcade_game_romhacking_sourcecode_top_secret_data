...
01D6A6	bne     $1d72a		[enemy+2E, enemy+6E]
01D6B0	bne     $1d72a		[enemy+ 5, enemy+45]
01D6B8	bcs     $1d72a		[123p+ 73]
01D78A	bcc     $1d7b8		[123p+ 2C]
01D798	beq     $1d7b2		[enemy+ 5, enemy+45]
01D822	bcc     $1d84e		[123p+ 2C]
01D830	beq     $1d7b2		[enemy+ 5, enemy+45]
...
04DA06	move.w  ($80,A6), D0		[enemy+45]
04DDF6	tst.b   ($26,A6)		[enemy+ 5, enemy+45]
04EEF8	move.b  #$a, ($78,A6)		[enemy+22, enemy+62]
04EEFE	move.w  ($8,A6), ($ae,A6)		[enemy+78, enemy+B8]
04EF04	move.b  ($bb,A6), ($23,A6)		[enemy+AE]
04EF0A	clr.b   ($5,A6)		[enemy+23, enemy+63]
04EF0E	clr.w   ($6,A6)		
04EF12	tst.w   ($6c,A6)		
...
05B256	clr.w   ($6,A6)		
05B25A	jsr     $326f8.l		
05B5C2	addq.b  #2, ($5,A6)		[enemy+ 0, enemy+A0]
05B5C6	move.w  ($80,A6), D0		[enemy+25, enemy+45]
