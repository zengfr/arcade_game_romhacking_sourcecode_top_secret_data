...
04E300	move.w  (A0)+, ($1c,A6)		[enemy+56]
04E304	clr.w   ($18,A6)		[enemy+5C]
04E308	clr.w   ($1e,A6)		
04E30C	move.b  #$1, ($51,A6)		
04E312	move.b  #$22, ($58,A6)		[enemy+91]
04E318	clr.b   ($5a,A6)		[enemy+98]
04E31C	clr.b   ($59,A6)		
04EE62	moveq   #$0, D0		[enemy+1C, enemy+5C]
...
05C3C2	move.w  (A0)+, ($1c,A6)		[enemy+16, enemy+56, enemy+76]
05C3C6	move.b  #$2, ($a4,A6)		[enemy+1C, enemy+5C, enemy+7C]
05C3CC	move.b  #$1, ($51,A6)		[enemy+24, enemy+44, enemy+A4]
05C3D2	move.b  #$4, ($6,A6)		[enemy+51, enemy+91, enemy+B1]
...
05C630	move.b  #$1, ($51,A6)		[enemy+56, enemy+76]
05C636	subq.b  #1, ($a4,A6)		[enemy+91, enemy+B1]
05C63A	bne     $5c670		[enemy+24, enemy+44]
05C642	clr.w   ($1c,A6)		
05C646	clr.b   ($51,A6)		
05C64A	move.l  #$5c6f0, ($40,A6)		
05C652	moveq   #$0, D0		[enemy+80, enemy+82]
