...
03B2B6	move.b  #$2, ($0,A6)		[enemy+20, enemy+22, enemy+40, enemy+42, enemy+60, enemy+62]
03B2BC	move.b  #$ff, ($7d,A6)		[enemy+ 0, enemy+20, enemy+A0]
03B2C2	move.b  #$10, ($25,A6)		[enemy+5D, enemy+7D, enemy+9D]
03B2C8	move.b  #$0, ($a8,A6)		[enemy+ 5, enemy+25, enemy+45]
...
0423BE	move.b  #$ff, ($7d,A6)		[enemy+ 0, enemy+20, enemy+A0]
0423C4	move.l  #$42516, ($40,A6)		[enemy+5D, enemy+7D, enemy+9D]
0423CC	clr.w   ($a0,A6)		[enemy+20, enemy+22, enemy+40, enemy+42, enemy+60, enemy+62]
...
042B7A	move.b  #$2, ($bd,A6)		[enemy+48, enemy+68, enemy+A8]
042B80	move.w  #$708, ($aa,A6)		[enemy+5D, enemy+7D, enemy+BD]
042B86	rts		[enemy+4A, enemy+6A, enemy+AA]
...
055B48	clr.b   ($4a,A6)		[enemy+ 4, enemy+ 6, enemy+24, enemy+26, enemy+64, enemy+66, enemy+84, enemy+86]
055B4C	move.b  #$ff, ($7d,A6)		
055B52	bsr     $55e9a		[enemy+3D, enemy+5D, enemy+9D, enemy+BD]
...
057932	blt     $5793e		[enemy+ 6, enemy+26, enemy+46, enemy+66, enemy+A6]
...
05EE28	moveq   #$0, D0		[enemy+40, enemy+42, enemy+60, enemy+62, enemy+80, enemy+82]
