...
03E8D6	bne     $3e8f2		[enemy+ 8, enemy+48, enemy+68, enemy+88]
03E8E0	moveq   #$0, D0		[enemy+ 8, enemy+48, enemy+68, enemy+88]
03E8E8	jsr     $32a70.l		[enemy+ 9, enemy+49, enemy+69, enemy+89]
...
03F1CE	jsr     $32a70.l		[enemy+ 9, enemy+49, enemy+69, enemy+89]
...
0537F0	bne     $5383a		[enemy+ 9, enemy+49, enemy+A9]
053858	move.b  ($22,A6), D0		[enemy+ 2, enemy+22, enemy+42, enemy+82]
05386A	movea.l ($64,A6), A0		[enemy+ 9, enemy+49, enemy+A9]
copyright	zengfr	site:http://github.com/zengfr/romhack
