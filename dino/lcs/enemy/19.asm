...
048B8C	addq.b  #1, ($67be,A5)		[enemy+1E, enemy+5E]
048BBC	clr.b   ($5a,A6)		[enemy+18, enemy+58]
048BC0	clr.b   ($59,A6)		
048BC4	move.b  ($67be,A5), ($5e,A6)		
048BCA	addq.b  #1, ($67be,A5)		[enemy+1E, enemy+5E]
048D64	subq.b  #1, ($59,A6)		[enemy+ 7, enemy+87]
048D68	beq     $48e02		[enemy+19, enemy+59]
053406	clr.b   ($7a,A0)		[enemy+ 4, enemy+ 6, enemy+84, enemy+86]
05340A	move.w  A6, ($68,A0)		
05340E	move.b  #$ff, ($2,A0)		[enemy+28, enemy+68]
053414	move.b  #$8, ($59,A0)		[enemy+ 2, enemy+82]
05341A	rts		[enemy+19, enemy+59]
