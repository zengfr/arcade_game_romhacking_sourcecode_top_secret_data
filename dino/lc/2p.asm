...
0013AC	bra     $13d0		
0013B0	clr.b   ($25,A6)		
0013B4	lea     ($2a8,PC) ; ($165e), A0		[FFB419]
0013B8	bra     $13d0		
...
0063EC	bls     $6418		[FFB460]
0063F0	btst    #$4, ($a0,A6)		
0063F6	beq     $6404		[FFB494]
0063FA	btst    #$5, ($a8,A6)		
006400	bne     $641a		
006404	btst    #$5, ($a0,A6)		
00640A	beq     $6418		[FFB494]
00640E	btst    #$4, ($a8,A6)		
006414	bne     $641a		
...
0098D6	bne     $98dc		[FFB3F7]
0098DC	moveq   #$0, D0		
0098DE	move.b  ($118,A6), D0		
0098E2	move.b  (A0,D0.w), D0		[FFB50C]
0098E6	moveq   #$5, D1		
0098E8	tst.b   ($24,A6)		
0098EC	beq     $98f2		[FFB418]
0098F2	swap    D1		
...
010088	andi    #$0, CCR		
01008C	abcd    -(A1), -(A2)		
01008E	abcd    -(A1), -(A2)		[FFB4F7]
010090	abcd    -(A1), -(A2)		[FFB4F6]
010092	abcd    -(A1), -(A2)		[FFB4F5]
010094	bcc     $1009e		[FFB4F4]
...
01012C	bsr     $101b6		[FFB4F4, FFB4F6]
...
010D5E	move.l  #$4000000, ($4,A3)		[FFC476]
010D66	clr.b   ($7a,A3)		[FFC47A, FFC478]
010D6A	move.w  A2, ($68,A3)		[FFC4EE]
010D6E	move.w  ($20,A2), D0		[FFC4DC]
010D72	movea.l #$a26fc, A4		[FFB414]
010D78	movea.l (A4,D0.w), A4		
010D7C	moveq   #$0, D0		
010D7E	move.b  ($58,A2), D0		
010D82	add.w   D0, D0		[FFB44C]
010D84	add.w   D0, D0		
010D86	adda.w  D0, A4		
010D9E	move.b  (A4)+, D0		[FFC4E0]
010DA0	move.b  (A4)+, D0		
010DA2	move.b  (A4), ($59,A3)		
010DA6	move.b  (A4)+, ($59,A2)		[FFC4CD]
010DAA	move.b  (A4)+, D0		[FFB44D]
010DAC	beq     $10db6		
010DB0	jsr     $962a.l		
010DF0	subq.w  #1, D7		
...
012748	move.w  (A6)+, D3		[FFB3FC, FFD6FC, FFDA7C, FF983C, FF99BC, FFD61C, FFD53C, FFCFFC, FF95FC, FFC47C, FFD99C, FFD45C, FF98FC, FFD29C, FF96BC, FFD37C, FFCF1C, FFD8BC, FFD7DC]
01274A	move.w  (A6)+, D4		
01274C	tst.b   ($24,A3)		
012750	beq     $12758		[FFD398, FFCF38, FFD8D8, FFD9B8, FFD7F8, FFD2B8, FF9858, FF9618, FF9918, FFDA98, FFB418, FFD718, FF96D8, FFD558, FFD638, FF99D8, FFC498, FFD478, FFD018]
012754	neg.w   D3		
012756	sub.w   D4, D3		
01277C	add.l   D2, D0		
01277E	lsr.l   #1, D0		
...
01974C	moveq   #$0, D0		[FFB44C]
01974E	move.b  D0, ($59,A6)		
019752	move.b  ($67be,A5), ($5e,A6)		[FFB44D]
019758	addq.b  #1, ($67be,A5)		[FFB452]
01975C	move.b  D0, ($b2,A6)		
019760	move.w  D0, ($16,A6)		[FFB4A6]
019764	move.w  D0, ($1c,A6)		[FFB40A]
019768	move.w  D0, ($18,A6)		[FFB410]
01976C	move.w  D0, ($1e,A6)		[FFB40C]
019770	move.b  D0, ($25,A6)		[FFB412]
019774	move.b  ($2c,A6), ($80,A6)		[FFB419]
01977A	move.b  D0, ($81,A6)		[FFB474]
01977E	move.w  #$500, D0		[FFB475]
019782	move.w  #$ffe0, D1		
019786	tst.b   ($24,A6)		
01978A	bne     $19792		[FFB418]
01978E	neg.w   D0		
019790	neg.w   D1		
019792	move.w  D0, ($14,A6)		
019796	move.w  D1, ($1a,A6)		[FFB408]
01979A	moveq   #$c, D0		[FFB40E]
01979C	jsr     $13a8.l		
0197A2	move.b  ($59,A6), D3		
0197A6	beq     $197b2		[FFB44D]
0197AA	subq.b  #1, D3		
...
0197C6	move.b  ($2c,A6), ($80,A6)		[FFB474]
0197CC	cmp.b   ($2c,A6), D0		[FFB474]
0197D0	beq     $19810		[FFB420]
0197D4	move.b  ($81,A6), D0		
0197D8	bne     $197f6		[FFB475]
0197DC	move.b  #$5a, ($58,A6)		
0197E2	moveq   #$0, D0		[FFB44C]
0197E4	move.b  D0, ($59,A6)		
0197E8	move.b  ($67be,A5), ($5e,A6)		[FFB44D]
0197EE	addq.b  #1, ($67be,A5)		[FFB452]
0197F2	bra     $1980c		
0197F6	move.b  #$5c, ($58,A6)		
0197FC	moveq   #$0, D0		[FFB44C]
0197FE	move.b  D0, ($59,A6)		
019802	move.b  ($67be,A5), ($5e,A6)		[FFB44D]
...
01AD0E	moveq   #$d, D0		[FFB3FA, FFB3F8]
01AD10	jsr     $13a8.l		
01AD16	move.b  #$10, ($58,A6)		
01AD1C	moveq   #$0, D0		[FFB44C]
01AD1E	move.b  D0, ($59,A6)		
01AD22	move.b  ($67be,A5), ($5e,A6)		[FFB44D]
01AD28	addq.b  #1, ($67be,A5)		[FFB452]
01AD2C	move.b  ($2c,A6), ($80,A6)		
01AD32	move.b  ($59,A6), D3		[FFB474]
01AD36	beq     $1ad4c		[FFB44D]
01AD3A	subq.b  #1, D3		
01AD3C	move.b  D3, ($59,A6)		
01AD40	beq     $1ad46		[FFB44D]
01AD44	rts		
01AD46	move.b  #$1, ($2f,A6)		
01AD4C	move.b  ($80,A6), D0		[FFB423]
01AD50	move.b  ($2c,A6), ($80,A6)		[FFB474]
01AD56	cmp.b   ($2c,A6), D0		[FFB474]
01AD5A	beq     $1ad74		[FFB420]
01AD5E	move.b  #$70, ($58,A6)		
01AD64	moveq   #$0, D0		[FFB44C]
01AD66	move.b  D0, ($59,A6)		
01AD6A	move.b  ($67be,A5), ($5e,A6)		[FFB44D]
01AD70	addq.b  #1, ($67be,A5)		[FFB452]
01AD74	tst.w   ($16,A6)		
01AD78	bpl     $1ad9c		[FFB40A]
01AD7C	jsr     $606e.l		
01AD82	tst.b   ($51,A6)		
01AD86	bne     $1ad9c		[FFB445]
01AD8A	moveq   #$0, D0		
01AD8C	move.w  D0, ($16,A6)		
01AD90	move.w  D0, ($1c,A6)		[FFB40A]
01AD94	move.b  D0, ($aa,A6)		[FFB410]
01AD98	bra     $1a81a		[FFB49E]
01AD9C	jsr     $1426.l		
01ADA2	bra     $1a6f8		
01BD96	andi.w  #$3, D1		
01BD9A	beq     $1bda6		
...
01C036	move.w  ($6,PC,D0.w), D1		[FFB3FA]
...
01C086	beq     $1cb78		
01C0DA	clr.b   ($23,A6)		
01C0DE	tst.w   ($6c,A6)		[FFB417]
01C0E2	bne     $1c0f4		[FFB460]
01C0F4	jsr     $183e4.l		
01C0FA	cmpi.b  #$4, ($7b,A6)		
01C100	beq     $1c110		[FFB46F]
01C104	move.b  #$1, ($0,A6)		
01C10A	jmp     $19122.l		[FFB3F4]
...
02596C	move.b  ($c4,A0), D0		[FF9724]
025970	beq     $259b2		[FFB4B8]
025974	move.b  ($b0,A6), D1		
025978	eor.b   D1, D0		[FF9764]
025988	clr.b   ($59,A6)		[FF970E]
02598C	move.b  ($67be,A5), ($5e,A6)		[FF970D]
025992	addq.b  #1, ($67be,A5)		[FF9712]
025996	cmpi.b  #$1, ($2c,A0)		
02599C	bne     $259b2		[FFB420]
0259A0	clr.b   ($2c,A0)		
0259A4	move.b  ($3,A6), D0		[FFB420]
0259A8	add.b   D0, ($49,A6)		[FF96B7]
0259AC	jsr     $4bda.l		[FF96FD]
...
032A86	rts		[FFD396, FFD7F6]
032A88	movea.w ($76,A6), A0		
032A8C	move.w  ($8,A0), D1		[FFD3EA]
032A90	move.w  ($10,A0), D2		[FFB3FC]
032A94	cmp.w   ($8,A6), D1		[FFB404]
032A98	ble     $32a9e		[FFD37C]
032A9C	neg.w   D0		
032AA6	move.b  D0, ($22,A6)		
032AAA	rts		[FFD396]
032B68	movea.w ($76,A6), A0		
032B6C	move.w  ($8,A0), D1		[FFD3EA]
032B70	move.w  ($10,A0), D2		[FFB3FC]
032B74	addi.w  #$400, D1		[FFB404]
032B78	move.b  #$0, ($24,A6)		
032B7E	move.w  ($8,A6), D2		[FFD398]
...
032DDE	move.w  D3, ($88,A6)		[FFB3FC]
032DE2	bra     $32df6		[FFD3FC]
032DE6	tst.w   D3		
...
035484	rts		[FFD99A, FFD29A, FFD8BA]
035486	movea.w ($76,A6), A0		
03548A	move.w  ($8,A0), D1		[FFD92A]
03548E	move.w  ($10,A0), D2		[FFB3FC]
035492	jsr     $103a.l		[FFB404]
035498	addi.b  #$10, D0		
03549C	andi.b  #$1f, D0		
...
0407D6	beq     $407ec		[FFD37A]
0407DA	movea.w ($76,A6), A0		
0407DE	cmpi.w  #$202, ($4,A0)		[FFD3EA]
0407E4	bne     $407ec		[FFB3F8]
0407EC	jsr     $49ca.l		
0407F2	jmp     $4bea.l		
045964	cmpi.w  #$50, D0		
045968	bcs     $45998		
